...
public:
	explicit DijkstraShortestPath(String id);
...
private:
	...
	DijkstraVertex& getDecoratedVersionOf(const Graph::Vertex& v) override;
	...
	void relaxEdge(const DijkstraVertex& start,
		           DijkstraVertex& end,
		           Graph::OutgoingEdge::Weight w);
private:
